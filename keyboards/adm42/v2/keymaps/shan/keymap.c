...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_QWERTY] = LAYOUT_3x12_6(
            LS_GRV,  KC_Q,    KC_W,    KC_D,    KC_F,    KC_P,    KC_K,    KC_L,    KC_U,    KC_Y,    KC_QUOT, RS_EQU,
            LC_TAB,  KC_A,    KC_R,    KC_S,    KC_T,    L_MEH,   R_MEH,   KC_N,    KC_E,    KC_O,    KC_I,    RC_SCLN,
    ...
    [_SPECIAL] = LAYOUT_3x12_6(
            ...
            KC_LALT, KC_AMPR, KC_AT,   KC_LCBR, KC_RCBR, KC_PIPE, KC_UNDS, KC_ASTR, KC_HASH, KC_PERC, KC_BSLS, LOR_ALT,
                                       XXXXXXX, _______, KC_DEL,  KC_ENT,  _______, CWD_TOG
    ),
    [_EXTRA] = LAYOUT_3x12_6(
            LS_F11,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  RS_F12,
            KC_LCTL, KC_PAUS, KC_INS,  KC_VOLD, KC_VOLU, KC_MUTE, KC_MS_L, KC_MS_D, KC_MS_U, KC_MS_R, KC_BTN1, KC_RCTL,
            KC_LALT, KC_SLEP, KC_PWR,  KC_MPRV, KC_MNXT, KC_MPLY, KC_HOME, KC_PGDN, KC_PGUP, KC_END,  KC_BTN2, LOR_ALT,
                                       KC_ESC,  _______, KC_DEL,  _______, _______, KC_CAPS
    ),
    [_ADM] = LAYOUT_3x12_6(
          RGB_WPM, RGB_SAI, RGB_SAD, RGB_VAI, RGB_VAD, RGB_M_B, KC_PCMM, KC_P7,  KC_P8, KC_P9, KC_PPLS, KC_PEQL,
          KGB_WHT, RGB_HUI, RGB_HUD, RGB_RMOD,RGB_MOD, RGB_TOG, KC_P0,   KC_P1,  KC_P2, KC_P3, KC_PMNS, KC_PAST,
          KGB_BLU, KGB_GRN, KGB_RED, RGB_SPI, RGB_SPD, RGB_M_P, KC_PDOT, KC_P4,  KC_P5, KC_P6, KC_PSLS, KC_PERC,
                            SETUP,   LS_SPC,  _______, XXXXXXX, RS_BPC,  KC_TAB
      ),
...
static modtap modtaps[] = {
    ...
    // LS_SPC
    {.mod = KC_LSFT, .tap = KC_SPC, .left = true},
    // LW_SPC
...
void config_pending(void) {
    ...
    if (user_config.pending_shift == 1) MODTAP(RS_BPC).pending_mod = true;
    ...
    if (user_config.pending_shift == 2) MODTAP(LS_SPC).pending_mod = true;
}
