...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_EXTRA] = LAYOUT_3x12_6(
            ...
            KC_LCTL, KC_SLEP,    LSG(KC_4),  KC_VOLD,    KC_VOLU,    KC_MUTE, KC_MS_L, KC_MS_D, KC_MS_U, KC_MS_R, XXXXXXX, KC_RCTL,
            KC_LALT, LGUI(KC_Z), LGUI(KC_X), LGUI(KC_C), LGUI(KC_V), KC_MPLY, KC_HOME, KC_PGDN, KC_MS_U, KC_END,  XXXXXXX, LOR_ALT,
