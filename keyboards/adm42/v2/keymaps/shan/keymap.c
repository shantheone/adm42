...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_EXTRA] = LAYOUT_3x12_6(
            ...
            KC_LCTL, KC_PAUS, KC_INS,  KC_VOLD, KC_VOLU, KC_MUTE, KC_HOME, KC_PGDN, KC_PGUP, KC_END,  KC_BTN2,  KC_RCTL,
            KC_LALT, KC_SLEP, KC_PWR,  KC_MPRV, KC_MNXT, KC_MPLY, KC_MS_L, KC_MS_D, KC_MS_U, KC_MS_R, KC_BTN1, LOR_ALT,
