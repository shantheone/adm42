...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_ADM] = LAYOUT_3x12_6(
            ...
            KGB_WHT, RGB_HUI, RGB_HUD, RGB_RMOD,RGB_MOD, RGB_TOG, KC_PDOT, KC_P4,  KC_P5, KC_P6, KC_PMNS, KC_PAST,
            KGB_BLU, KGB_GRN, KGB_RED, RGB_SPI, RGB_SPD, RGB_M_P, KC_P0,   KC_P1,  KC_P2, KC_P3, KC_PSLS, KC_PERC,
